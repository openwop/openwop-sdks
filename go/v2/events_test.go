...
//
// Parallel to:
//   - sdk/typescript-v2/src/__tests__/event-helpers.test.ts
//   - sdk/python-v2/tests/test_events.py
//
// Schema-mirror sanity test reads schemas/v2/run-event-payloads.schema.json
...
func TestSchemaMirror_AgentDefsMatchExpectedRequired(t *testing.T) {
	// Find the vendored v2 schema. Path: go/v2/ → repo-root/
	// → schemas/v2/run-event-payloads.schema.json.
	schemaPath := filepath.Join("..", "..", "schemas", "v2", "run-event-payloads.schema.json")
