...
#
# Sources: spec/v2/errors.json (registry version 2.0, updated 2026-09-23, 106 codes) and schemas/v2/capabilities.schema.json (72 families, 17 metadata keys), both vendored at CORPUS_TAG.
